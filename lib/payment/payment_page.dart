...
class PaymentSheetMobile extends StatefulWidget {
  const PaymentSheetMobile({super.key});

  @override
  _PaymentSheetMobileState createState() => _PaymentSheetMobileState();
}

class _PaymentSheetMobileState extends State<PaymentSheetMobile> {
  int step = 0;
    ...
    try {
      ...
      await Stripe.instance.initPaymentSheet(
        paymentSheetParameters: SetupPaymentSheetParameters(
          ...
          merchantDisplayName: 'Franchise Management',
